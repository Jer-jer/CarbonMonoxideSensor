                ...
                <div class="container bud">
                    <div class="fluid-container flex-child first">
                        <form method="POST" action="/#">
                            ...
                            <p id="date" class="labels hakdog2"></p>
                            <br>
                            <br>
                            ...
                            <button type="submit" name="submit" class="btn btn-primary button" style="margin-bottom: 15px !important;">Submit</button>
                        </form>
                    </div>
...
<script>
    ...
    document.getElementById("date").innerHTML = m + "/" + d + "/" + y + " " + weekday[dy];
</script>
